...
BINARIES=dataProj testStats1 testStatsData1 testStatsData2 main1
...
testStatsData1: placeData.o rating.o testStatsData1.o stats.o comboHospitalData.o hospitalData.o comboDemogData.o demogData.o parse.o  tddFuncs.o statTool.o
	${CXX} $^ -o $@
...
main1: placeData.o rating.o main1.o stats.o comboHospitalData.o hospitalData.o comboDemogData.o demogData.o parse.o  tddFuncs.o statTool.o
	${CXX} $^ -o $@
